"""
Django settings for projectYoutube project.
...
SECRET_KEY = 'dy*zer51c9&o#(92)vn%p32^_t1cuw(jw4z5j5v%^dxpgr0i8n'
...
ROOT_URLCONF = 'projectYoutube.urls'
...
WSGI_APPLICATION = 'projectYoutube.wsgi.application'
